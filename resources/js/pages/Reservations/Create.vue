    ...
    <div class="p-6">
      ...
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center space-x-4">
          <Button variant="ghost" @click="$inertia.visit('/reservations')" class="p-2">
            <ArrowLeft class="w-4 h-4" />
          </Button>
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Create Reservation</h1>
            <p class="text-gray-600 mt-1">Create a new vehicle reservation</p>
          </div>
        </div>
      </div>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Select @update:model-value="handleVehicleSelect">
                  <SelectTrigger class="mt-2">
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
              <Button type="button" variant="outline" @click="$inertia.visit('/reservations')">
                Cancel
              </Button>
